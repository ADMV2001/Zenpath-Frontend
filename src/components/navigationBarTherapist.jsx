...
export default function TherapistNavBar(isLoggedIn) {
  ...
  return (
    <header className="relative w-full h-[70px] flex items-center justify-between md:px-10 lg:px-16 font-[poppins]  top-0 bg-gradient-to-r from-white to-blue-100 border-b border-gray-200 z-50">
      {/* Left Side - Logo */}
      <div className="flex items-center">
        <img src="/logo.png" alt="logo" className="w-[50px] h-[50px] object-cover ml-2 md:ml-10 lg:ml-20 xl:ml-28" />
        <h1 className="ml-2 font-semibold text-[22px] md:text-[25px] text-[#023E8A]">ZenPath | Therapist Dashboard</h1>
      </div>
